...
function sidebarSetting(){
	...
	echo '<div class="sidebar-setting sidebar-container">
		  <ul>
			...
			<li><a href="/settings/account" class="sidebar-menu-setting symbol"><span>Grandverse Settings</span></a></li>
			<li><a href="/titles/'.$announce['title_id'].'" class="sidebar-menu-info symbol"><span>Announcements</span></a></li>
...
function noUser(){
	echo '<title>Error</title><div id="main-body"><div class="no-content track-error" data-track-error="404"><div><p>The user could not be found.</p></div></div>';
}
