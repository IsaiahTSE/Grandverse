...
if($_SERVER['REQUEST_METHOD'] != 'POST'){
	$tabTitle = 'Grandverse - Community Creation';
	printHeader('');

	echo '<div id="main-body">';
	$get_user = $dbc->prepare('SELECT * FROM users INNER JOIN profiles ON profiles.user_id = users.user_id WHERE users.user_id = ? LIMIT 3');
